...
%for key, x in res.iteritems():
  %if key=="checkin_0":
    <h2>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp1 Check in Class info:</h2>
    %for item, seg in x.iteritems():
...
%for key, x in res.iteritems():
  %if key=="checkin_1":
    <h2>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp2 Check in Class info:</h2>
    %for item, seg in x.iteritems():
    <p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp {{item}}-> {{seg}}</p>
    %end
  %end
...
%for key, x in res.iteritems():
  %if key=="grade_0":
    <h2>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp1 Grade Class info:</h2>
    %for item, seg in x.iteritems():
...
%for key, x in res.iteritems():
  %if key=="grade_1":
    <h2>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp2 Grade Class info:</h2>
    %for item, seg in x.iteritems():
    <p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp {{item}}-> {{seg}}</p>
    %end
  %end
